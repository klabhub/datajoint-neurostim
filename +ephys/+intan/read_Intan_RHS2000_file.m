...
if pv.headerOnly
    ...
    if (data_present)
        ...
        bytes_remaining = filesize - ftell(fid);
        if (bytes_remaining ~= 0)
            fprintf(2,'Error: End of file not reached. Something is off with data file %s' ,filename);
        end
        ...
        if (num_gaps == 0)
            ...
            fprintf(2, 'Warning: %d gaps in timestamp data found.  Time scale will not be uniform!\n', ...
                num_gaps);
        end
